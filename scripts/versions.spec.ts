...
const cases: TestCase[] = [
  ...
  {
    description:
      'should return previous stable for new next release if there are no previous next releases',
  ...
  {
    description:
      'should return previous stable for new alpha release if there are no previous alpha releases',
  ...
  {
    description:
      'should return previous alpha for new beta release if there are no previous beta releases',
    newVersion: '1.1.1-beta.0',
    previousVersion: '1.1.1-alpha.0',
  },
  {
    description:
      'should return previous stable for nee beta release if there are no previous alpha and beta releases',
  ...
  {
    description:
      'should return previous beta for new rc release if there are no previous rc releases',
    newVersion: '2.3.0-rc.0',
    previousVersion: '2.3.0-beta.0',
  },
  {
    description:
      'should return previous alpha for new rc release if there are no previous rc and beta releases',
    newVersion: '1.1.1-rc.0',
    previousVersion: '1.1.1-alpha.0',
  },
  {
    description:
      'should return previous stable version for rc release if there are nor previous prereleases',
    newVersion: '2.1.0-rc.0',
    previousVersion: '2.0.0',
  },
  {
    description:
      'should return previous non standard release (no alpha,beta,rc) for other prereleases',
...
function testCaseFactory(testCase: TestCase): void {
  it(testCase.description, () => {
    expect(
      extractPreviousVersionForChangelog(testVersions, testCase.newVersion)
    ).toBe(testCase.previousVersion);
  });
  return;
}
