...
export class UserAddressesEffects {
  ...
  showGlobalMessageOnAddSuccess$ = this.actions$.pipe(
    ...
    tap(() => {
      this.loadAddresses();
      this.showGlobalMessage('globalMessage.addUserAddressSuccess');
    })
  );
  ...
  showGlobalMessageOnUpdateSuccess$ = this.actions$.pipe(
    ...
    tap(() => {
      this.loadAddresses();
      this.showGlobalMessage('globalMessage.updateUserAddressSuccess');
    })
  );
  ...
  showGlobalMessageOnDeleteSuccess$ = this.actions$.pipe(
    ...
    tap(() => {
      this.loadAddresses();
      this.showGlobalMessage('globalMessage.deleteUserAddressSuccess');
    })
  );
